      ...
      {carreras.map((c) => (
        ...
        >
          <div
            className={
              isLarge
                ? "w-36 h-36 lg:w-40 lg:h-40 flex-shrink-0 rounded-xl overflow-hidden bg-[var(--color-linea)]"
                : "w-28 h-28 flex-shrink-0 rounded-xl overflow-hidden bg-[var(--color-linea)]"
            }
          >
            <div
